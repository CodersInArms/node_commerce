...
/*filter to show 4 new products at the click of the load more button
But it is not working :/
*/
app.filter('showMoreProducts', function(){
    return function(input, n){
        if(!(toString.call(input) === '[objectArray]')){
            return input;
        }
